 ...
 let canvas = document.getElementById('stage');
  ...
  if(value=="dinesh"){
    console.log("User entered Dinesh");
    const myImage = document.getElementById("myImage");
    const imageUrl = `images/dinesh.jpg`;
    const hoverUrl = "images/dineshbg.jpg";
  ...
  if(value=="rajasekar"){
    ...
    console.log("User entered Rajasekar");
    const myImage = document.getElementById("myImage");
    const imageUrl = `images/rajasekar.jpg`;
    const hoverUrl = "images/rajasekarbg.jpg";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
    canvas.style.display="";
  ...
  if(value=="vinothkumar"){
    console.log("User entered Vinothkumar");
    const myImage = document.getElementById("myImage");
    const imageUrl = `images/vinothkumar.jpg`;
    const hoverUrl = "images/vinothkumarbg.jpg";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
    canvas.style.display="";
  ...
  if(value=="ajithkumar"){
    console.log("User entered AjithKumar");
    const myImage = document.getElementById("myImage");
    const imageUrl = `images/ajithkumar.jpg`;
    const hoverUrl = "images/ajithkumarbg.jpg";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
    canvas.style.display="";
  ...
  if(value=="praveenkumar"){
    console.log("User entered PraveenKumar");
    const myImage = document.getElementById("myImage");
    const imageUrl = `images/praveenkumar.jpg`;
    const hoverUrl = "images/praveenkumarbg.jpg";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
    canvas.style.display="";
  ...
  if(value=="govindhan"){
    console.log("User entered Govindhan");
    const myImage = document.getElementById("myImage");
    const imageUrl = `images/govindhan.jpg`;
    const hoverUrl = "images/govindhanbg.jpg";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
    canvas.style.display="";
